...
prompt +=  "\n(Enter 'quit' whe you done)"

while True:
    city = input(prompt)
    #here is similar to flag logic but simpliest code cuz of break
    #  I can just write break and assign it to logic
    if city == 'quit':
        break
    else:
...
while active:
    ...
    if message == 'quit':
        ...
        print(f"You are under {message} y.o. and your ticket is free")
    elif int(message) <= 12:
        print(f"You are under {message} y.o. and your ticket is 10$")
    elif int(message) > 12:
